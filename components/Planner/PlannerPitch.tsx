...
export default function PlannerPitch({ players, onUpdateSquad, onTransferClick,onRemovePlayer }: PlannerPitchProps) {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="relative w-full max-w-[580px] lg:max-w-[800px] xl:max-w-[900px] h-[75vh] sm:h-[80vh] max-h-[800px] rounded-xl overflow-hidden border border-green-500/20 shadow-2xl bg-[#041f17]">
        {/* Pitch Visuals */}
